            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/80 border-b border-slate-100">
                  <th className="px-6 py-3 text-[12px] font-black uppercase tracking-widest text-slate-400">Unidad</th>
                  <th className="px-6 py-3 text-[12px] font-black uppercase tracking-widest text-slate-400">Huésped / Documento</th>
                  <th className="px-6 py-3 text-[12px] font-black uppercase tracking-widest text-slate-400">Check-In</th>
                  <th className="px-6 py-3 text-[12px] font-black uppercase tracking-widest text-slate-400">Check-Out</th>
                  <th className="px-6 py-3 text-[12px] font-black uppercase tracking-widest text-slate-400 text-center">Estado</th>
                  <th className="px-6 py-3 text-[12px] font-black uppercase tracking-widest text-slate-400 text-right">Parking</th>
                </tr>
              </thead>
