      ...
      <div className="bg-white rounded-xl border border-[var(--color-border)] shadow-[var(--shadow-surgical)] overflow-hidden">
        {isLoading ? (
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#001640]">
                <th className="px-6 py-4 text-[12px] font-black uppercase tracking-widest text-white/90">Destinatario</th>
                <th className="px-6 py-4 text-[12px] font-black uppercase tracking-widest text-white/90">Unidad</th>
                <th className="px-6 py-4 text-[12px] font-black uppercase tracking-widest text-white/90">Asunto</th>
                <th className="px-6 py-4 text-[12px] font-black uppercase tracking-widest text-white/90">Estado</th>
                <th className="px-6 py-4 text-[12px] font-black uppercase tracking-widest text-white/90 text-right">Fecha</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-50">
              {petitions.map(petition => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="text-[12px] font-bold text-slate-600 line-clamp-1 group-hover:text-slate-900 transition-colors">
                      {petition.title}
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span className={`px-2 py-0.5 text-[10px] font-black uppercase tracking-tighter border rounded-full ${getStatusStyle(petition.status)}`}>
