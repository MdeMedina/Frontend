...
export const actionIcons: Record<AuditAction, string> = {
  PETITION_CREATED: 'description',
  PETITION_APPROVED: 'check_circle',
  PETITION_REJECTED: 'cancel',
  USER_CREATED: 'person_add',
  USER_UPDATED: 'edit',
  USER_DEACTIVATED: 'block',
  USER_ACTIVATED: 'check',
  MANAGER_ASSIGNED: 'badge',
  MANAGER_REMOVED: 'person_remove',
  RESERVATION_CREATED: 'event',
  RESERVATION_UPDATED: 'update',
  RESERVATION_CANCELLED: 'delete',
  CHECKIN_CONFIRMED: 'login',
  CHECKOUT_CONFIRMED: 'logout',
  APARTMENT_CREATED: 'apartment',
  APARTMENT_UPDATED: 'build',
  APARTMENT_DEACTIVATED: 'domain_disabled',
  APARTMENT_BULK_IMPORT: 'upload_file',
  USER_LOGIN: 'key',
  USER_LOGOUT: 'logout',
